...
admin.register(Stock, session=db.session)
admin.register(Cart, session=db.session)
admin.register(Bank, session=db.session)
admin.register(Investment, session=db.session)
